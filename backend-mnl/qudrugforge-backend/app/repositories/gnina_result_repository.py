...
class GninaResultRepository:
    ...
    async def ensure_indexes(self):
        ...
        await self.collection.create_index("source_docking_experiment_id")
        ...
        await self.collection.create_index("cnn_affinity")
        await self.collection.create_index("cnn_pose_score")
        ...
        await self.collection.create_index(
            [("project_id", pymongo.ASCENDING), ("molecule_id", pymongo.ASCENDING)]
        )
        await self.collection.create_index(
            [("project_id", pymongo.ASCENDING), ("target_id", pymongo.ASCENDING)]
        )
    ...
    async def list_results(
        ...
        if source_docking_experiment_id:
            try:
                query["source_docking_experiment_id"] = ObjectId(source_docking_experiment_id)
            except Exception:
                query["source_docking_experiment_id"] = source_docking_experiment_id
